...
- [ ] T018 Apply restored and forward Identity migrations to a disposable database matching the production baseline; verify no existing Identity table is re-created. **Dependencies:** T006, T011.
