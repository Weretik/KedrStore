...
// Абсолютный путь к файлу safelist
const safelistFile = path.resolve(__dirname, 'wwwroot/css/tailwind.safelist.txt');

let safelist = [];
if (fs.existsSync(safelistFile)) {
    const content = fs.readFileSync(safelistFile, 'utf-8');
    safelist = content
        .split('\n')
        .map(x => x.trim())
...
module.exports = {
    ...
    content: [
        ...
        "./**/*.cshtml",
        "./**/*.html",
        "./Presentation.Client/**/*.razor",
        "./Presentation.Client/**/*.cshtml",
        "./Presentation.Client/**/*.html",
    ],
    plugins: [],
};
